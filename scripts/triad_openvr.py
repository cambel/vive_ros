...
class vr_tracked_device():
    def __init__(self, vr_obj : openvr.VRSystem, index, device_class):
    ...
    def get_state(self):
        return self.vr.getControllerState(self.index)
    
    def trigger_haptic_pulse(self,):
    #         vr_.TriggerHapticPulse(msg->id, 0, (int)(msg->intensity));
    # for (int i = 0; i < 16; i++)
    #   vr_.TriggerHapticPulse(i, 0, (int)(msg->intensity));
        self.vr.triggerHapticPulse(self, self.index, 0, 3999) # intensity from 0 to 3999
